---
title: "Assignment 1 Text Analytics"
author: 
  - "Larissa van Boxem"
  - "Ralph Schuurman"
  - "Danique Osinga"
...
#Save pca results
#saveRDS(pca_results_loaded,'pca_results_loaded.rds')
...
ncomp <- 2
#pca_results_test <- readRDS(file = "/Users/ralph/TA-Assignment1/pca_results_loaded.rds")
pca_results_test <- readRDS(file = "pca_results_loaded.rds")
rawLoadings <- pca_results_test$rotation[sortednames,1:ncomp] %*% diag(pca_results_test$sdev, ncomp, ncomp)
rotated <- varimax(rawLoadings)
pca_results_test$rotation <- rotated$loadings
pca_results_test$x <- scale(pca_results_test$x[,1:ncomp]) %*% rotated$rotmat
...
<<<<<<< HEAD
reviews_lda_subset$text <- enc2utf8(reviews_lda_subset$text)
...
>>>>>>> 088ef98151a1716f80f180b04dbc83cef43e7784
