...
#Save pca results
save(pca_results, file = 'pca_results.Rdata')
...
ggplot( ,aes(polarity)) +
  ...
  ggtitle("Polarity histogram with negators and amplifiers")
...
ggplot( ,aes(polarity3)) +
    ...
    geom_histogram(aes(fill = "Unhappy"), data = neg_reviews, alpha = 0.5) +
    scale_colour_manual("Polarity", values = c("green", "red"), aesthetics = "fill") + 
  ggtitle("Polarity histogram with no negators and with amplifiers")+ labs(x = "polarity")
...
ggplot( ,aes(polarity3)) +
    ...
    geom_histogram(aes(fill = "Unhappy"), data = neg_reviews, alpha = 0.5) +
    scale_colour_manual("Polarity", values = c("green", "red"), aesthetics = "fill") + 
  ggtitle("Polarity histogram with negators and with no amplifiers")+ labs(x = "polarity")
...
index <- sample(1:nrow(reviews_backup), 2000)
